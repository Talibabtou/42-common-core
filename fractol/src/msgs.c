...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/01/27 18:12:39 by gdumas            #+#    #+#             */
/*   Updated: 2024/02/13 17:58:09 by gdumas           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	print_fractal_options(void)
{
	...
	ft_putendl_fd("\e[36mUsage example:\t\
./fractol <type>\n\t\t./fractol M\e[0m", 1);
...
====================+", 1);
	...
	ft_putendl_fd("\nFor Julia, you can also specify color after", 1);
